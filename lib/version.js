        ...
        if (options.analyze) {
            if (options.verbose) {
                wrongLines.forEach(function(wrongLine) {
                    ...
                    if (options.fix) {
                        console.log(spacer22 + chalk.black.bgYellow('[Line: ' + wrongLine.lineNumber + ']   ' + line[0]) + chalk.white.bold.bgRed(line[2]) + chalk.white.bold.bgGreen(replaced) + chalk.black.bgYellow(line[3]));
                    }
                    else {
